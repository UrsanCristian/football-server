...
public class TeamController {
    ...
    @GetMapping
    public List<TeamDTO> getTeams(){return teamService.getAllTeams();}


    @GetMapping("/{id}")
    public TeamDTO getTeamById(@PathVariable int id){ return teamService.getTeamById(id);}
    ...
    @GetMapping("/country")
    public TeamDTO getTeamByCountry(@RequestParam String country){
